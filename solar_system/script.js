$(window).load(function () {
  ...
  var planetTexts = {
    ...
    venus: [
      "Venus is often called Earth's sister planet due to its similar size and mass.",
    ...
    earth: [
      ...
      "It has a diverse range of ecosystems, climates, and landforms.",
      "Earth's atmosphere contains approximately 21% oxygen, crucial for sustaining life as we know it",
    ],
    mars: [
      "Mars is often called the Red Planet due to the iron oxide on its surface, giving it a reddish appearance",
      "It has the tallest volcano and the deepest canyon in our solar system, Olympus Mons and Valles Marineris, respectively.",
      "Scientists have found evidence suggesting that liquid water may have existed on Mars in the past",
    ],
    jupiter: [
      "Jupiter is the largest planet in our solar system and has a strong magnetic field",
      "It has a prominent feature called the Great Red Spot, a massive storm that has been raging for at least 350 years",
      "Jupiter has a large number of moons, with the four largest known as the Galilean moons: Io, Europa, Ganymede, and Callisto.",
    ],
    saturn: [
      "Saturn is famous for its stunning ring system, composed of ice and rock particles.",
      "It is the least dense of all the planets, and if you could find a bathtub large enough, Saturn would float",
      "Saturn has a hexagonal-shaped storm at its north pole, discovered by the Cassini spacecraft",
    ],
    uranus: [
      "Uranus is unique among the planets because it rotates on its side, likely due to a massive collision early in its history",
      "It has a pale blue color, attributed to the presence of methane in its atmosphere",
      "Uranus was the first planet discovered with a telescope, by German-born British astronomer Sir William Herschel in 1781.",
    ],
    neptune: [
      "Neptune is the farthest planet from the Sun in our solar system",
      "It has the fastest winds in the solar system, reaching speeds of up to 1,500 miles per hour",
      "Neptune's blue color is also attributed to methane in its atmosphere, similar to Uranus",
    ],
    sun: [
      "The Sun is a giant ball of hot, ionized gas, primarily composed of hydrogen (about 74%) and helium (about 24%)",
      "The Sun is about 100 times wider than Earth and about 10 times wider than Jupiter, the biggest planet.",
      "The Sun is the only star in our solar system",
      "The Sun goes through an approximately 11-year solar cycle",
    ],
  };
  ...
  var quizzes = {
    ...
    mars: [
      "Mars has the tallest volcano and the deepest canyon in our solar system.",
      "True",
      "You are correct!!",
      "You are wrong :(",
    ],
    ...
    saturn: [
      "Saturn's stunning ring system is made of solid gold",
      "True",
      "You are correct!!",
      "You are wrong :(",
    ],
    ...
    neptune: [
      "Neptune's atmosphere contains a significant amount of methane, giving it a blue color",
      "True",
      "You are correct!!",
      "You are wrong :(",
    ],
    sun: [
      "The Sun is a solid, rocky body",
      "False",
      "You are wrong :(",
      "You are correct!!",
    ],
  ...
  function createPopup(planet) {
    ...
    $("#popup-fact2").text(
      planetTexts[planet][1] || "No information available."
    );
    $("#popup-fact3").text(
      planetTexts[planet][2] || "No information available."
    );
